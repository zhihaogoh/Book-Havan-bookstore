//used list product , product detials, favourite_product
...
//used shopping cart, check out, check out status
export const cart = [
  {
    id: 1,
    BookName: "The Seven Husbands of Evelyn Hugo",
...
//used address list, address detial 
